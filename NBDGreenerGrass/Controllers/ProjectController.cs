...
namespace NBDGreenerGrass.Controllers
{
    public class ProjectController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,StartDate,EndDate,DateMade,Location,Amount,ClientID")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,StartDate,EndDate,DateMade,Location,Amount,ClientID")] Project project)
        {
            if (id != project.ID)
            {
                return NotFound();
